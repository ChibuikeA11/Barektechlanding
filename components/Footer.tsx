...
const Footer: React.FC = () => {
  return (
    <footer className="bg-background border-t border-stone-900 pt-16 pb-8 text-stone-400">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <IconButton asChild variant="soft" color="gray" className="bg-stone-900 text-stone-500 hover:text-stone-100 hover:bg-stone-800">
