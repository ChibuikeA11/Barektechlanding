...
const cardBase = "group relative overflow-hidden rounded-3xl bg-[var(--c-card)] backdrop-blur-xl border border-[var(--c-card-border)] shadow-card-lg hover:border-c-line transition-colors duration-500 min-h-[360px] p-8 flex flex-col justify-between";
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center justify-center px-4 py-1.5 rounded-full bg-c-bg-2 border border-c-line mb-6">
            <span className="text-xs font-medium text-c-fg-4 uppercase tracking-widest">Our Ecosystem</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 text-c-fg">
            Selected Ventures
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Trimly — flagship */}
          <Card className={`${cardBase} md:col-span-2 lg:col-span-2`}>
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-c-fg mb-3 tracking-tight group-hover:text-c-fg-em transition-colors">Trimly.</h3>
            ...
            <div className="relative z-10 mt-8">
              <div className="flex items-center gap-1 h-8 opacity-40 group-hover:opacity-80 transition-opacity">
                {[40, 60, 30, 80, 50, 90, 40, 60, 30, 50, 70, 40, 60].map((h, i) => (
                  <div key={i} className="w-1.5 bg-c-fg-5 rounded-full" style={{ height: `${h}%` }} />
                ))}
              </div>
            </div>
          </Card>
          ...
          <Card className={`${cardBase} lg:col-span-1`}>
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-c-fg mb-3 tracking-tight group-hover:text-c-fg-em transition-colors">GlamUp.</h3>
              <p className="text-c-fg-5 text-sm leading-relaxed max-w-sm">
          ...
          <Card className={`${cardBase} lg:col-span-1`}>
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-c-fg mb-3 tracking-tight group-hover:text-c-fg-em transition-colors">Genna.</h3>
              <p className="text-c-fg-5 text-sm leading-relaxed max-w-sm">
            ...
            <div className="relative z-10 mt-8 w-full max-w-[200px]">
              <div className="space-y-2 opacity-50 group-hover:opacity-80 transition-opacity">
                <div className="h-1.5 w-full bg-c-bg-3 rounded-full overflow-hidden">
                  <div className="h-full w-3/4 bg-c-fg-5 rounded-full" />
                </div>
                <div className="h-1.5 w-full bg-c-bg-3 rounded-full overflow-hidden">
                  <div className="h-full w-1/2 bg-c-fg-6 rounded-full" />
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className={`${cardBase} md:col-span-2 lg:col-span-2`}>
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl font-bold text-c-fg mb-3 tracking-tight group-hover:text-c-fg-em transition-colors">NeuroCare.</h3>
              <p className="text-c-fg-5 text-sm leading-relaxed max-w-sm">
            ...
            <div className="relative z-10 mt-8 flex items-center opacity-40 group-hover:opacity-80 transition-opacity">
              ...
              <div className="h-4 w-4 border-l border-t border-c-fg-5 transform -rotate-45 translate-y-2" />
              <div className="h-8 w-4 border-r border-b border-c-fg-4 transform -rotate-12 -translate-y-2" />
        ...
        <div className="mt-16 flex justify-center">
          <a href="#" className="group flex items-center gap-2 text-c-fg-4 hover:text-c-fg-em transition-colors text-sm font-medium">
            View full portfolio
            <span className="bg-c-bg-3 p-1 rounded-full group-hover:bg-c-line-2 transition-colors">
